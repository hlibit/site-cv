...
function AboutMeSection({ data }) {
  return (
    <div className="mt-auto flex max-h-full w-full flex-col gap-6 overflow-auto">
      <div className="max-w-[600px] text-sm font-normal leading-8 tracking-wider text-text-primary">
      ...
      <div className="grid grid-cols-1 grid-rows-6 gap-1 sm:gap-4 md:grid-cols-2 md:grid-rows-3">
        {data.map((detail) => {
          return (
